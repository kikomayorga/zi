...
echo 240 > /etc/zi/timers/saldo1
echo 240 > /etc/zi/timers/saldo2
echo 240 > /etc/zi/timers/saldo3
echo 240 > /etc/zi/timers/saldo4 
echo 240 > /etc/zi/timers/saldo5
echo 240 > /etc/zi/timers/saldo6
